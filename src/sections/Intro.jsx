...
import { Music, Music2, Music3, Music4, Heart, Briefcase, Mic, Mic2, Headphones, Radio, Star, Disc3, Volume2, Users, Zap, Award, Globe, MapPin, Camera, Video, Sparkles, Flame, Guitar, Drum } from 'lucide-react';
import { useContent } from '../hooks/useContent';

export const ICON_MAP = {
  Music, Music2, Music3, Music4,
  Mic, Mic2,
  Headphones, Radio, Guitar, Drum,
  Disc3, Volume2,
  Heart, Star, Sparkles, Flame, Zap,
  Briefcase, Users, Award, Globe,
  MapPin, Camera, Video,
};
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {introData.services.map((service, index) => {
            const Icon = ICON_MAP[service.icon] || Music;
            return (
              <motion.div
                key={service.title}
                initial={{ opacity: 0, y: 20 }}
